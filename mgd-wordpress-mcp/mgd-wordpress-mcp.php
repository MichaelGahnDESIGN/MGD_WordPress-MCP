...
define( 'MGD_WPMCP_VERSION', '0.5.1' );
...
require_once MGD_WPMCP_DIR.'includes/class-mgd-wordpress-mcp-approvals.php';
require_once MGD_WPMCP_DIR.'includes/class-mgd-wordpress-mcp-doctor.php';
require_once MGD_WPMCP_DIR.'includes/class-mgd-wordpress-mcp-client-config.php';
